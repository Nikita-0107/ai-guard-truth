...
function AuthPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-hero grid place-items-center px-4 py-10">
      <Link
        to="/"
      ...
      <div className="w-full max-w-md animate-fade-up">
        <div className="glass-strong rounded-3xl p-8 shadow-elegant">
          <div className="mb-6 text-center">
            <div className="mx-auto mb-4 grid h-12 w-12 place-items-center rounded-2xl bg-gradient-brand shadow-glow">
              <Shield className="h-6 w-6 text-primary-foreground" strokeWidth={2.5} />
            </div>
            <h1 className="text-2xl font-semibold">Welcome to Sentinel</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Your AI fraud investigator, ready to protect you.
            </p>
          </div>
          ...
          <Button
            ...
            className="w-full glass border-border/60 hover:bg-accent"
          >
            <GoogleIcon />
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            By continuing you agree to Sentinel's terms & privacy policy.
          </p>
        </div>
      </div>
    </div>
